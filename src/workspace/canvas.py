...
class PaintArea(QWidget):
    ...
    def drawAxis(self):
        ...
        # Draw axis
        #======================================================================
        axis_length = Vector2D(self.geometry().width(),
                               self.geometry().height()).norm()
        
        x_unit = Vector3D(1, 0, 0)
        y_unit = Vector3D(0, 1, 0)
        z_unit = Vector3D(0, 0, 1)
        
        x = x_unit.project(self.R, self.v0)*axis_length
        y = y_unit.project(self.R, self.v0)*axis_length
        z = z_unit.project(self.R, self.v0)*axis_length
